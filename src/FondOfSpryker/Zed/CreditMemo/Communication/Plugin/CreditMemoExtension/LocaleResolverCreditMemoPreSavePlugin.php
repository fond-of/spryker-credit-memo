 ...
 */
class LocaleResolverCreditMemoPreSavePlugin extends AbstractPlugin implements CreditMemoPreSavePluginInterface
{
    /**
    ...
    {
        return $this->getFacade()->addLocaleToCreditMemo($creditMemoTransfer);
    }
}
